...
\begin{tabular}{| p{6.5cm} | p{6.5cm} | p{6.5cm} |}
    ...
    \hline
    nslookup <<servername>> & shows ip adress of servername & \\ 
    \hline
    sudo ifconfig enx00e04cebfbd5 192.168.0.4 netmask 255.255.255.0 & set ip adress for (sub)network & enx00e04cebfbd5 = networkdevice \\
                                                                                                    &&192.168.0.4 = new ip adress \\
                                                                                                    &&255.255.255.0 = mask \\
    \hline
    pdfjam --outfile out.pdf --paper a4paper in.pdf & makes pdf to a4 & \\
    \hline 
    lazygit & opens a programming managing git/github & \\
    \hline
    vproject & opens txt files with project ideas to customize my laptop & \\ 
    \hline
    qrencode -s 6 -l H -o "wifi.png" "WIFI:T:WPA;S:<SSID>;P:<PSWD>;;" & wlanlogin to qrcode, did not work with me & \\ 
    \hline
    z tor and ./star... & opens tor in tor-browser & \\
    \hline
    idevicebackup2 -i encryption on & start encryption mode for backup & \\
    \hline
    idevicebackup2 backup --full /path/to/backup/ & make backup of iphone & \\
    \hline
\end{tabular}
